...
import re
scaling_factor=1.0
# After running scripts/optimization_BO, copy from model directory a file that contains the top20 mols from BO
file_path = os.path.join(os.getcwd(), 'top20_mols_-0.05.txt')
...
plt.savefig('optimal_mols_BO.png', bbox_inches='tight', pad_inches=0.1, dpi=300)
import json
